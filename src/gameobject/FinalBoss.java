...
public class FinalBoss extends Human {
    ...
    public FinalBoss(float x, float y, GameWorldState gameWorld) {
        super(x, y, 110, 150,"finalBoss", 0.1f, 200, gameWorld);
    ...
    public void draw(Graphics2D g2) {
        ...
        if(getState() == NOBEHURT && (System.nanoTime()/10000000)%2!=1)
        {
        	...
        	g2.fillRect((int)(getPosX() - getGameWorld().camera.getPosX()-80), 
                    (int)(getPosY() - getGameWorld().camera.getPosY()-85),202,10+2);
        	g2.setColor(Color.PINK );
        	g2.fillRect((int)(getPosX() - getGameWorld().camera.getPosX()-80), 
                    (int)(getPosY() - getGameWorld().camera.getPosY()-85),(int)getBlood(),10);
            if(attackType[attackIndex].equals("NONE")){
